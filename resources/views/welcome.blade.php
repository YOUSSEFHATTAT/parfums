...
<style>
    :root {
        --primary-color: #D4AF37; /* Or luxueux */
        --primary-light: #F8E9A1; /* Or clair */
        --primary-dark: #A67C00; /* Or foncé */
        --accent-color: #D4AF37; /* Accent doré */
        --text-light: #F8E9A1; /* Texte clair doré */
        --text-dark: #000000; /* Texte noir */
        --text-muted: #A67C00; /* Texte doré atténué */
        --bg-light: #000000; /* Fond noir */
        --bg-gray: #111111; /* Fond gris foncé */
        --shadow-sm: 0 2px 10px rgba(212, 175, 55, 0.15); /* Ombre dorée légère */
        --shadow-md: 0 4px 20px rgba(212, 175, 55, 0.2); /* Ombre dorée moyenne */
        --shadow-lg: 0 10px 30px rgba(212, 175, 55, 0.3); /* Ombre dorée forte */
        --radius-sm: 8px;
        --radius-md: 12px;
        --radius-lg: 20px;
    ...
    .welcome-container {
        ...
        color: var(--text-light);
        padding: 60px 20px;
        background-image: url('{{ asset('images/acc.webp') }}');
    ...
    <div class="features">
        <div class="feature-box animate-fade-in delay-1">
            ...
            <div class="feature-box-content">
                ...
                <a href="{{ route('produits.show', 4) }}" class="btn">Voir le produit</a>
            </div>
        </div>

        <div class="feature-box animate-fade-in delay-2">
            <a href="{{ route('produits.show', 17) }}">
            ...
            <div class="feature-box-content">
                ...
                <a href="{{ route('produits.show', 17) }}" class="btn">Voir le produit</a>
            </div>
        </div>

        <div class="feature-box animate-fade-in delay-3">
            <a href="{{ route('produits.show', 6) }}">
            ...
            <div class="feature-box-content">
                ...
                <a href="{{ route('produits.show', 6) }}" class="btn">Voir le produit</a>
            </div>
        </div>
    </div>
</div>
